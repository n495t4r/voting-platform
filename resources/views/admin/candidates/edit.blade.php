...
<div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="mb-6">
        ...
        <p class="text-gray-600">Editing: <span class="font-medium">{{ $candidate->name }}</span> for Position: <span
                class="font-medium">{{ $position->title }}</span></p>
    </div>
    <div class="card-mobile">
        <form method="POST" action="{{ route('admin.candidates.update', [$election, $position, $candidate]) }}"
            ...
            <div class="flex flex-col sm:flex-row gap-3">
                ...
                <a href="{{ route('admin.candidates.index', [$election, $position]) }}"
